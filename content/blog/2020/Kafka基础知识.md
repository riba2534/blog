...
- Kafka引入了 Consumer Group模式来进行工作
  ...
  - 一个Group内可以有多个消费者，Group内的消费者以队列模式进行工作
    ...
    ![img](https://img.riba2534.cn/images/2026/04/40e67fbd_fcbe7162-e0b8-4925-9e5a-3aa05761a3c7-5127810.jpg)
...
- Partition与消费模型
  ...
  - Partition中的消息可以被不同的Group多次消费，那Partition中被消费的消息是何时删除的？Partition是如何知道一个Consumer Group的消费位置呢？
    ...
    - Partition会为每一个Consumer Group保存一个偏移量，记录Group的消费位置：
      ...
      - 消费位置图
        ...
        ![img](https://img.riba2534.cn/images/2026/04/6bceeb76_e85ce207-1343-4ce2-902b-caa367099d7b-5127810.jpg)
  ...
  - Group中的Consumer是如何与Partition对应的
    ...
    - 消费关系对应图
      ...
      ![img](https://img.riba2534.cn/images/2026/04/c6a4254e_776b6786-a728-4900-80b9-e5a3c6899d38-5127810.jpg)
...
- 物理存储
  ...
  - 物理机可能损坏，所以我们要进行一定的数据冗余
    ...
    ![img](https://img.riba2534.cn/images/2026/04/b6e62428_f4ee764a-dc49-403c-bfb2-2fe35bb576c4-5127810.jpg)
