...
> 原文链接：[The 10am Drop: How Jane Street Broke Bitcoin's Price](https://x.com/1914ad/status/2026757796390449382)
>
> 原文作者：Justin Bechler (@1914ad)
>
...
让我们首次将三条线索串联起来：一桩围绕名为 "Bryce's Secret" 私密聊天群建立的**联邦内幕交易案**，一种在 2025 年下半年系统性地于上午 10 点执行抛售程序以压制比特币价格的模式，以及一本未披露的衍生品账簿——它可能使历史上最大的比特币 ETF 持仓沦为**压制比特币价格的工具**。

All three threads lead back to one name: **Jane Street Capital**.

三条线索都指向同一个名字：**Jane Street Capital**。
...
Pratt 曾在 Terraform Labs 实习，这是一家总部位于新加坡的公司，也是算法稳定币 TerraUSD 及其代币 Luna 的幕后团队。他离开 Terraform 后，于 **2021 年 9 月**加入 Jane Street 成为全职员工。
...
Jane Street 同样是 **SBF** 在创立 FTX 和 Alameda Research 之前学习交易的地方，他未来的许多同事也出自这家公司或与其人脉网络有交集。
...
根据 Terraform 破产管理人 Todd Snyder 提起的诉讼，Pratt 通过一个在法庭文件中被称为 **"Bryce's Secret"** 的聊天群，成为了他前雇主与新雇主之间的桥梁。
...
诉讼指控 Jane Street 利用这一渠道获取了关于 Terraform **内部流动性操作的重大非公开信息**。
...
关键时刻发生在 **2022 年 5 月 7 日**。Terraform 从 Curve3pool（一个作为该稳定币主要流动性枢纽的去中心化交易平台）撤出了 1.5 亿美元的 TerraUSD。在该笔撤出后的十分钟内，在 Terraform 向公众发布任何通知或公告之前，一个与 Jane Street 关联的钱包就从同一池中提走了 **8500 万美元的 TerraUSD**。
...
两者叠加的抛售压力促使 UST 脱离了美元锚定。数日之内，Luna 的算法铸造与销毁机制彻底失控，代币供应量恶性膨胀，**400 亿美元市值灰飞烟灭**。散户投资者遭受了毁灭性损失。
...
根据诉讼，Jane Street 在恰到好处的时机平仓，**"在 Terraform 生态系统崩溃前仅仅数小时"**，从而避免了超过 2 亿美元的潜在风险敞口。
...
诉讼称这些交易**"如果没有 [Jane Street] 独家获取的内幕信息，是不可能完成的"**。
...
Jane Street 称这起诉讼"孤注一掷"且"毫无根据"，辩称 Terra 和 Luna 持有者遭受的损失是由 **Terraform 自身的欺诈**造成的。
...
Do Kwon 目前正在服 15 年有期徒刑。Snyder 还另外向 Jump Trading 提起了一桩 **40 亿美元的诉讼**，指控其操纵了同一场崩盘，这表明对 Terra 死亡螺旋期间机构行为的调查是**系统性的**，而非仅仅针对单一公司的孤立索赔。
...
从 2024 年末开始，并在 2025 年持续加速，比特币的价格开始出现一种交易员们注意到却**无法解释**的现象。
...
每个交易日东部时间上午 10 点，恰好与美股开盘时间重合，比特币都会经历突然而剧烈的抛售。这些下跌精准、带有算法特征，且与整体市场状况**严重不成比例**。它们扫掉杠杆多头仓位，触发连锁清算，然后在数小时内反转。
...
区块链分析公司 Glassnode 的联合创始人 Jan Happel 和 Yann Allemann 通过他们的共享账号 Negentropic 记录了这些模式。他们追踪了数月交易数据中下跌的算法精度，这一模式毫不隐晦。12 月的图表显示，比特币在上午 10 点开盘后的几分钟内从 **\$89,700 跌至 \$87,700**，在反弹前抹去了 1.71 亿美元的多头仓位。
...
Jane Street 作为多只比特币 ETF 的指定做市商和授权参与者，同时拥有库存和基础设施，能够在可预测的流动性窗口期大规模执行协调性卖出。在开盘时向稀薄的订单簿抛售会压低价格，触发杠杆交易者的连锁清算，并在更低的价位创造买入机会。然后该公司可以在自己一手制造的行情**底部重新入场**。
...
据 Glassnode 的联合创始人称，在 Terraform Labs 诉讼文件于去年初公开之后，每日闪崩便停止了。比特币价格在随后的交易时段中显著企稳。这种行为变化与一家突然需要考虑**法律证据开示和取证程序**的公司表现一致。

The 10am pattern resumed in Q3 2025. By December, it was back with full force.

上午 10 点的模式在 2025 年第三季度恢复。到 12 月，它已全面回归。
...
简单来说，上午 10 点的砸盘在 Jane Street 有律师盯着的那一刻就停了，而**风头一过就又卷土重来**。
...
在 2025 年第四季度的 13F 文件中，Jane Street 披露持有 20,315,780 股 IBIT，价值约 **7.9 亿美元**。仅该季度，该公司就增持了 7,105,206 股，增加了 2.76 亿美元。去年某一时点，其 IBIT 总仓位价值接近 25 亿美元。
...
与此同时，该公司将其 MicroStrategy 股票持仓增加了 **473%**，累积了 951,187 股，价值约 1.21 亿美元，而同期 BlackRock 和 Vanguard 却在大举抛售价值数十亿美元的 MSTR。

This looks like bullish accumulation if you don't understand what Jane Street actually is.

如果你不了解 Jane Street 的**真正角色**，这看起来就像是看涨的建仓行为。
...
Jane Street 是仅有的四家被授权对 IBIT 进行实物申赎的公司之一。其他三家是 Virtu Americas、JP Morgan Securities 和 Marex。Jane Street 同时也是 Fidelity 和 WisdomTree 比特币 ETF 的授权参与者。这一角色使该公司能够直接触及连接 ETF 份额价格与实际比特币的机制。Jane Street 可以将真实的比特币移入和移出 ETF 结构，在基金与现货市场之间套利，并维持**远超任何普通市场参与者所能积累**的库存仓位。
...
简单来说，Jane Street **直接掌控着那条管道**——连接比特币 ETF 与实际比特币的管道，而几乎没有其他人能做到这一点。
...
加密媒体将这份 13F 报告解读为机构坚定看好的信号。而真正理解市场结构的人**立刻表示并非如此**。
...
前对冲基金经理 Michael Green 称对 Jane Street 13F 报告的看涨解读"令人痛心"。他指出，Jane Street 的 IBIT 持仓"几乎完全被未披露的期权和期货头寸所对冲"，而且"他们绝对不是在'积累' Bitcoin 头寸。**这就是做市商的运作方式。**"
...
前自营交易员 Ryan Scott 说得更直白："任何把这当作看涨信号发布的人都犯了不可饶恕的错误。正确的标题应该是'**你绝对猜不到谁还持有无需披露的对冲衍生品头寸**。'"
...
Nik Bhatia 把问题归结为利益驱动："Jane Street 持有 IBIT，是为了卖出期权、套利，以及**量化交易公司用来快速赚钱的一切手段。**"

Here is what this means for every person who holds Bitcoin or IBIT.

以下是这对每一位持有 Bitcoin 或 IBIT 的人意味着什么。
...
13F 报告披露的是多头股票持仓，不要求披露期权、期货或互换合约。当 Jane Street 报告持有 7.9 亿美元的 IBIT 份额时，这份文件并不能告诉你这些份额是否被看跌期权对冲、被空头期货抵消，或是被领口策略包裹，从而使**该公司的 Bitcoin 净敞口为零甚至为负。**
...
这就是每个 Bitcoin 持有者都应该追问、且无法回避的问题。如果该公司持有 7.9 亿美元的 IBIT 份额，同时用 7.9 亿美元的看跌期权或空头期货对冲该头寸，**净敞口就是零。** 如果衍生品账面超过了股票持仓，净敞口则为负——这意味着 Jane Street 在 Bitcoin 价格下跌时获利。
...
Jane Street 在 Bitcoin 市场中的行为尚未受到监管机构的审查。**但其在其他市场中的行为已经被审查过。**
...
2025 年，印度证券交易委员会（SEBI）发布了一份针对 Jane Street 旗下实体的 **105 页执法令**，指控其操纵 BANKNIFTY 指数期权。
...
SEBI 发现，该公司通过在现货和衍生品市场之间的协同交易，在两年内获取了 36,502 亿卢比（约 43 亿美元）的利润，其中**单日最高获利达 735 亿卢比。**
...
监管机构将该活动定性为在任何拥有正常运作的金融监管机构的国家都明显违法的行为，并对该公司的交易实施了临时限制。Jane Street 在印度指数衍生品中的策略遵循一个熟悉的模式：**利用特权级别的速度和规模撬动一个市场**，然后在其上层的衍生品层面收割利润。

The question is whether the same logic applies to Bitcoin.

问题是，同样的逻辑是否也适用于 Bitcoin。
...
2100 万枚的硬顶上限由主权 Bitcoin 节点网络强制执行。
...
这一上限的前提假设是：价格发现是诚实的，市场反映的是真实的供需关系，并且当机构持有 Bitcoin 或 Bitcoin 相关工具时，其头寸代表的是**对该资产的真实敞口**，而非对所有其他市场参与者不可见的衍生品策略的原材料。

In other words, **the 21M cap only works if the market sitting on top of it is honest.**

换句话说，**2100 万枚的上限只有在其上层市场诚实运作的前提下才有意义。**
...
Jane Street 是掌握 Bitcoin ETF 基础设施钥匙的四家公司之一。它面临一项联邦诉讼，被指控通过内部人驱动的抢先交易帮助摧毁了 400 亿美元的市值。它被指控运行算法卖出程序，连续数月压制 Bitcoin 价格。而且它持有已披露的最大 Bitcoin ETF 头寸，同时维护着**一本可能使其真实敞口与文件所显示的完全相反的衍生品账簿。**
...
因此，当 Jane Street 可以通过在自身 ETF 库存之上叠加未披露的衍生品来**凭空制造无限的合成供给**时，这个上限就变得毫无意义。
...
Bitcoin 在协议层面的稀缺性是真实的，但其上层的价格发现机制已经被一家将特权准入当作利润引擎的公司所侵蚀，而**当前的披露框架允许他们在无人监督的情况下这样做。**

Every Bitcoin holder deserves to know: **what is Jane Street's actual net position?**

每一位 Bitcoin 持有者都有权知道：**Jane Street 的真实净头寸到底是多少？**

Until we know, Jane Street decides the price of Bitcoin.

在我们得到答案之前，Bitcoin 的价格由 Jane Street 说了算。
