...
> **转载说明**：本文原作者为 [Jensen Huang](https://en.wikipedia.org/wiki/Jensen_Huang)（英伟达 NVIDIA 创始人兼 CEO）。原文发布于 2026 年 3 月 10 日的 NVIDIA Blog。原文链接：[AI Is a 5-Layer Cake](https://blogs.nvidia.com/blog/ai-5-layer-cake/)。以下为中英双语对照版本，英文为原文，中文为翻译。
>
> **作者简介**：黄仁勋（Jensen Huang），英伟达（NVIDIA）联合创始人、总裁兼 CEO。1993 年创立 NVIDIA，将其从一家图形芯片公司转型为 AI 计算领域的领导者。被业界称为"AI 教父"之一。
...
AI 是当今塑造世界最强大的力量之一。它不是一个聪明的应用程序或单一的模型；它是**基础设施**，就像电力和互联网一样。
...
AI 运行在真实的硬件、真实的能源和真实的经济学之上。它将原材料转化为大规模的智能。每家公司都将使用它。每个国家都将建设它。
...
在计算历史的大部分时间里，软件是预录的。人类描述算法，计算机执行它。数据必须被仔细地结构化，存储到表格中，并通过精确的查询来检索。SQL 变得不可或缺，因为它使那个世界变得可行。
...
我们第一次拥有了一台能够理解非结构化信息的计算机。它可以看图像、读文本、听声音并理解含义。它可以推理上下文和意图。最重要的是，它**实时生成智能**。
...
在最顶层是应用，这是创造经济价值的地方。药物发现平台。工业机器人。法律副驾驶。自动驾驶汽车。自动驾驶汽车是**嵌入**机器中的 AI 应用。人形机器人是**嵌入**身体中的 AI 应用。同样的栈。不同的结果。
...
每一个成功的应用都会拉动其下的每一层，一直到维持其运转的发电厂。
...
我们才刚刚开始这一建设。目前已投入数千亿美元。**仍有数万亿美元的基础设施需要建设。**
...
在世界各地，我们正看到芯片工厂、计算机组装厂和 AI 工厂以前所未有的规模建设。这正在成为**人类历史上最大规模的基础设施建设**。
...
支持这一建设所需的劳动力是巨大的。AI 工厂需要电工、水管工、管道安装工、钢铁工人、网络技术员、安装人员和操作员。
...
这些都是高技能、高薪的工作，而且供不应求。**你不需要计算机科学博士学位就能参与这场变革。**
...
与此同时，AI 正在推动整个知识经济的生产力提升。以放射科为例。AI 现在协助阅读扫描影像，但对放射科医生的需求仍在增长。这并不是一个悖论。
...
放射科医生的宗旨是照护患者。阅读扫描影像只是其中一项任务。当 AI 承担更多常规工作时，放射科医生可以专注于判断、沟通和护理。医院变得更高产。它们服务更多患者。它们雇佣更多人。
...
在过去一年中，AI 跨越了一个重要门槛。模型变得足够好，可以大规模实用。推理能力提升。幻觉减少。**接地能力**大幅改善。基于 AI 的应用首次开始创造真正的经济价值。
...
药物研发、物流、客户服务、软件开发和制造业的应用已经展现出强劲的产品市场契合度。这些应用强力拉动其下的每一层。
...
开源模型在这里发挥着关键作用。世界上大多数模型是免费的。研究人员、初创公司、企业和整个国家都依赖开源模型参与先进 AI。当开源模型达到前沿水平时，它们不仅改变软件，还**激活整个技术栈的需求**。
...
AI 始于 Transformer LLM。但它远不止于此。它是一场**工业变革**，重塑了能源的生产和消费方式、工厂的建设方式、工作的组织方式以及经济的增长方式。
...
AI 工厂正在建设，因为智能现在是实时生成的。芯片正在重新设计，因为效率决定了智能扩展的速度。能源变得至关重要，因为它设定了智能生产总量的上限。应用加速发展，因为其下的模型已经跨越了一个门槛，终于可以大规模实用。
...
这就是为什么建设规模如此之大。这就是为什么它同时触及如此多的行业。这也是为什么它不会局限于单个国家或单个领域。**每家公司都将使用 AI。每个国家都将建设它。**
...
我们仍处于早期阶段。大部分基础设施尚不存在。大部分劳动力尚未接受培训。大部分机会尚未实现。
...
AI 正在成为现代世界的基础设施。我们现在所做的选择——我们建设得有多快、我们参与得有多广泛、我们部署得有多负责任——将塑造这个时代变成什么样。
