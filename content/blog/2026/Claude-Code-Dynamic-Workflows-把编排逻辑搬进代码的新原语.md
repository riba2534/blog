...
一句话：**Workflow 是把这套手搓 harness 产品化了，省的是工程脏活，不是改变模型。** 理解了这一层，你对它的能力边界也就有了底——它没什么魔法，就是一个把"`claude -p` + 编排循环"打磨得足够顺手的运行时。
...
- [Recursive Language Models（RLM 论文，MIT CSAIL，arXiv:2512.24601）](https://arxiv.org/abs/2512.24601)