...
| 日期 | 项目 | 版本 | 技术要点 |
|------|------|------|----------|
| 2012-04-20 | Shadowsocks | Python 版 | 首个版本发布，确立 SOCKS5 代理架构 |
| 2015-04 | Shadowrocket | - | iOS 首个主流代理客户端上架 |
| 2015-08-21 | Shadowsocks | - | 项目归档，转向社区维护 |
| 2015-09-18 | V2Ray | v0.1 (beta) | 首个公开版本，引入 VMess 协议与 UUID 认证 |
| 2015-10 | Surge | - | iOS 代理工具鼻祖，定义规则分流标准 |
| 2016 | WireGuard | - | 首次发布，现代 VPN 协议 |
| 2017 | Brook | - | 极简跨平台代理工具发布 |
| 2017-02-18 | V2Ray | v2.19 | VMess 强制防重放机制，AEAD 加密升级 |
| 2017–2018 | Trojan | - | HTTPS 伪装协议诞生 |
| 2018 | MTProxy | - | Telegram 官方代理协议推出 |
| 2019 | NaiveProxy | - | 基于 Chromium 网络栈的代理方案 |
| 2020-07-16 | VLESS | - | 无状态轻量协议提案 (Issue #2636) |
| 2020 | Trojan-Go | - | Go 语言重写，支持多路复用与 CDN 中转 |
| 2020-03 | WireGuard | Linux 5.6 | 正式进入 Linux 内核 |
| 2020-09-15 | shadowsocks-libev | v3.3.5 | 稳定迭代与 AEAD 加密路线的延续 |
| 2022-10-29 | Xray-core | v1.6.2 | XTLS Vision 发布，优化 TLS 握手特征 |
| 2023-03-09 | Xray-core | v1.8.0 | REALITY 协议发布，无需自购域名 |
| 2023-11 | Clash/CFW | - | 项目归档，Mihomo 接手维护 |
| 2024-09-30 | Xray-core | v24.9.30 | XHTTP 协议整合 HTTP/3 与 XMUX |
...
历史转折点。原作者 clowwindy 因个人原因在 GitHub 留下 [告别留言](https://github.com/shadowsocks/shadowsocks-iOS/issues/124) 后停止维护并删除了项目代码。这一事件促成了 SS 的社区化维护。社区接手后，`shadowsocks-libev`（C 语言版）与后来的 `shadowsocks-rust` 成为长期迭代的中流砥柱（如 2020 年 9 月 15 日发布的 v3.3.5），显示了开源社区持续维护与迭代的能力。
...
- **2020-11：Project X 成立** - 因 XTLS 许可协议讨论，rprx 创建 [Project X (Xray-core)](https://xtls.github.io/about/news.html)。这是一个重要节点，Xray 随后推出了 uTLS（指纹模拟）和 FakeDNS（虚假 DNS 响应，用于实现透明代理的域名嗅探）等技术，推动了协议特性的持续创新。
...
|---------------|----------|---------------|----------|----------|----------|----------|
| v2rayN (Windows) | Xray-core / sing-box | 原生路由 (Rule Provider 需适配) | 支持 TUN (基于 sing-box；虚拟网卡 sing-tun，使用 Wintun 驱动；需管理员权限) | DNS 分流 (支持 FakeIP 仅在 Tun 模式下；支持 DoH 配置项) | 活跃 | 2026-01-09 |
| Clash Verge Rev | Mihomo | 完美支持 | 支持 (System/Tun) | — | 活跃 | — |
| OpenClash | Mihomo | 支持 (Rule-Set) | 支持 (Tun) | Fake-IP | 活跃 | — |
| v2rayNG | Xray / sing-box | — | Android VPN | — | 活跃 | — |
| sing-box | sing-box | 原生 (JSON) | Native Tun | DNS Server | 活跃 | — |
